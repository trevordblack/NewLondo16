...
1) Convert NL16 into binary
  Functions as an attempt at creating binary for the ensuing hdl
  This pass will not support binary or decimal hex values

2) Convert all Supported Syntax to NL16 Syntax
  This pass functions to convert binary & decimal into hexidecimal
  The assumption is that binary & decimal will only be used by human coders
  This optimization can be switched off when compiling from a high-level language
